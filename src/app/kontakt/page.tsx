...
const PRODUCT_NAME = "CE-Pilot";
const PRODUCT_DOMAIN = "ce-pilot.de";
const CONTACT_EMAIL = "info@ce-pilot.de";
        ...
        <div className="mx-auto max-w-7xl">
          <div className="rounded-2xl border bg-gradient-to-br from-primary/5 via-background to-primary/10 p-8 sm:p-12">
            ...
            <div className="text-center">
              <Link href="/ce-kennzeichnung-software" className="inline-flex items-center gap-2 rounded-xl bg-primary px-8 py-3 text-sm font-semibold text-primary-foreground shadow-sm hover:bg-primary/90 transition-colors">
