...
const PROJECT_ID = "ce-pilot";
const PROJECT_DOMAIN = "leistungserklaerung-software.de";
const PROJECT_DISPLAY_NAME = "CE-Pilot";
const PROJECT_PRIMARY_COLOR = "#2563EB";
const PROJECT_ACCENT_COLOR = "#1E40AF";
const PROJECT_ADMIN_EMAIL = "info@leistungserklaerung-software.de";
const PROJECT_TAGLINE = "Automatische DoP-Generierung, FPC-Zertifikat-Tracking, CE-Kennzeichnungs-Generator mit allen Pflichtangaben, WPK-Verknüpfung — EU-Bauproduktenverordnung (CPR 305/2011) konform";
